    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg text-center">
          Chat PDF te permite mantener conversaciones con cualquier documento
          PDF. Simplemente carga tu archivo y empieza a hacer preguntas
        </p>
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">
              Empieza a chatear en minutos
            </h2>
            <p className="mt-4 text-lg text-gray-600">
              Hablar con tus PDF nunca fue tan fácil con Chat PDF
            </p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0 md:px-4">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                Puedes empezar con un plan gratuito o elegir nuestro{" "}
                <Link
                  href="/pricing"
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                Procesamos tu archivo PDF y lo dejamos listo para que puedas
                chatear con el.
              </span>
            </div>
          </li>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                ¡Es así de sencillo! Prueba hoy Chat PDF en segundos.
              </span>
            </div>
          </li>
        </ol>
